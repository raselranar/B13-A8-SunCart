...
export const metadata = {
  title: "SunCart | Summer Products",
  description: "Browse our full collection of summer essentials",
};
...
const ProductsPage = async () => {
  ...
  return (
    <section className="bg-background">
      {/* banner */}
      <div className="bg-linear-to-r from-red-300 to-red-200">
      ...
      <div className="container mx-auto py-12">
        <p className="mb-4 px-4 text-gray-500 text-sm">
